...
public class SnakeView extends TileView {
    ...
    public Bundle saveState() {
        ...
        map.putInt("mDirection", Integer.valueOf(getmDirection()));
        map.putInt("mNextDirection", Integer.valueOf(getmNextDirection()));
        map.putLong("mMoveDelay", Long.valueOf(getmMoveDelay()));
    ...
    public void restoreState(Bundle icicle) {
        ...
        setDirection(icicle.getInt("mDirection"));
        setNextDirection(icicle.getInt("mNextDirection"));
        setmMoveDelay(icicle.getLong("mMoveDelay"));
    ...
    public void moveSnake(int direction) {
        ...
        if (direction == Snake.MOVE_DOWN) {
            if (getmDirection() != NORTH) {
                setNextDirection(SOUTH);
            }
            return;
        }

        if (direction == Snake.MOVE_LEFT) {
            if (getmDirection() != EAST) {
                setNextDirection(WEST);
            }
            return;
        }

        if (direction == Snake.MOVE_RIGHT) {
            if (getmDirection() != WEST) {
                setNextDirection(EAST);
            }
            return;
        }
    ...
    public void update() {
        if (mMode == RUNNING) {
            ...
            if (now - mLastMove > getmMoveDelay()) {
                clearTiles();
                updateWalls();
                updateSnake();
                updateApples();
            ...
            mRedrawHandler.sleep(getmMoveDelay());
        }
    ...
    private void updateSnake() {
        ...
        setDirection(getmNextDirection());
        ...
        for (int appleindex = 0; appleindex < applecount; appleindex++) {
            ...
            if (c.equals(newHead)) {
                ...
                mScore++;
                setmMoveDelay(((long) (getmMoveDelay() * 0.9)));
